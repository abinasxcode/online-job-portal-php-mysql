...
.btn-hero:hover{ transform: translateY(-2px); filter: brightness(1.08); box-shadow: 0 18px 40px rgba(34,211,238,.35); }
...
@media (min-width: 768px){
  .rj-rail{ grid-auto-columns: minmax(300px, 1fr); }
    ...
    <!-- HOME -->
    <!-- HERO / HOME -->
<section class="home-section hero-v2 hero-3d" id="home-section">
  <!-- 3D Globe (desktop) -->
  <div id="globe-container"></div>
  <!-- Particle fallback (mobile) -->
    ...
    <div class="row align-items-center justify-content-center min-vh-75">
      <div class="col-lg-10">
        ...
        <div class="text-center mb-3">
          <span class="hero-badge animate__animated animate__fadeInDown"><i class="fa fa-bolt mr-1"></i> Find your next role</span>
        </div>

        <!-- Headline -->
        <div class="text-center mb-4">
          <h1 class="display-4 hero-title animate__animated animate__fadeInUp stagger-1">
            <span class="hero-gradient animate-float" style="display:inline-block;">Connecting Careers, Creating Futures</span>
          </h1>
          <p class="lead text-light mb-0 animate__animated animate__fadeInUp stagger-2">Who understands it’s personal? We do. To us, it’s about <strong>you</strong>.</p>
        </div>

        <!-- Search card -->
        <form method="post" action="search.php" class="search-card mt-4 search-jobs-form animate__animated animate__fadeInUp stagger-3 glass-effect">
          ...
          <div class="text-center mt-3">
            <button type="submit" name="submit" class="btn btn-primary btn-lg px-5 animate__animated animate__zoomIn stagger-4" style="transition: transform 0.3s; box-shadow: 0 4px 15px rgba(34,211,238,0.5);" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-6 col-md-3 reveal" style="transition-delay: 0.3s">
        <div class="stat-box">
          <div class="stat-number" data-count="4200">0</div>
    ...
    <section class="site-section next-section">
      <div class="container">
        <h4 class="text-center mb-4 section-title">Recently Posted Jobs</h4>
...
?>
<li class="job-card animate__animated animate__fadeInUp" style="animation-delay: <?php echo min($jobStagger++ * 0.1, 0.5); ?>s;">
  ...
  <div class="container">
    ...
    <div class="rj-rail-wrap">
      <div class="rj-rail" id="rjRail" tabindex="0" aria-label="Jobs carousel">
        ...
        ?>
        <a class="rj-card animate__animated animate__fadeInRight" style="animation-delay: <?php echo min($jobStagger++ * 0.1, 0.5); ?>s;" href="jobs/job-single.php?id=<?= (int)$j->id ?>" aria-label="View <?= htmlspecialchars($j->job_title) ?>">
